...
//boilerplate implementatition doesnt neccessarily work. Delibratly commented out!
...
//}
//
//TEST(CalcMgdIeAnodeTest, TestWithValidInputs) { // I can also test for invalid inputs at were p=0 and kv =0
//    u8 kv = 80;
//    u8 p = 3;
//    u32 interpol = 2000;
//    u8 filter = 2;
